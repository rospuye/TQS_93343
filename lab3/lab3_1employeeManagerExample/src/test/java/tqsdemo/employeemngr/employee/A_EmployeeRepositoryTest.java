...
class A_EmployeeRepositoryTest {
    ...
    // this entity accesses the database and writes to it directly
    @Autowired
    ...
    // test the "find by name" functionality
    @Test
    ...
    // when we search for a name that doesn't exist in the DB,
    // the employeeRepository should return null
    @Test
    ...
    // test the "find by ID" functionality
    @Test
    ...
    // when we search for an ID that doesn't exist in the DB,
    // the employeeRepository should return null
    @Test
    ...
    // test the "find all" functionality
    @Test
